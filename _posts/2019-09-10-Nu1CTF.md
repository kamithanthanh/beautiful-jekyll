...
Sau đó chúng ta ghi đè 1 bytes "\x00" lên bytes cuối cùng của ```_IO_write_base``` để nó trỏ sang một địa chỉ khác. Từ đó in thêm cho chúng ta một số thông tin về địa chỉ của libc.   
