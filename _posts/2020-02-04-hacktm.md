...
### Critical Bug   
Chúng ta có thể lặp vô hạn lần, nên khi lưu trạng thái lên stack -> buffer overflow.  
Overflow đến chỗ ```nStep``` ( là chỗ chứa số kí tự đã ghi) cần cẩn thận :vv  Overflow cho nó thành số lớn lớn 
